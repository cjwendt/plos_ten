...
\newcommand{\getAff}[1]{
  \getIndex{#1}{Colorado State University,Colorado State University}
}
...
\\
G. Brooke Anderson\textsuperscript{\getAff{Colorado State University}}\textsuperscript{*},
Caroline J. Wendt\textsuperscript{\getAff{Colorado State University}}\\
\bigskip
\textbf{\getAff{Colorado State University}}Department of Environmental \& Radiological Health Sciences, 1681 Campus
Delivery, Fort Collins, Colorado, 80523\\
\textbf{\getAff{Colorado State University}}Department of Mathematics, Department of Statistics, Fort Collins,
Colorado, 80523\\
\bigskip
