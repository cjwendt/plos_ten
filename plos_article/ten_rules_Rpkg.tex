...
\texttt{tidyverse} workflow {[}74,75{]}. Furthermore, the \texttt{caret}
...
{[}77,78{]}. Functions are necessary for efficiency and warranted when
...
documentation with reproducibility and collaboration in mind {[}79{]}.
...
\texttt{roxygen2}, \texttt{rlang}, \texttt{drat}) {[}32,38,80--83{]}. In
...
77. Harrell Jr FE, Charles Dupont, others. Hmisc: Harrell miscellaneous
{[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=Hmisc}

\leavevmode\hypertarget{ref-broman}{}%
78. Broman KW. Broman: Karl broman's r code {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=broman}

\leavevmode\hypertarget{ref-parker2013}{}%
79. Parker H. Personal r packages {[}Internet{]}. 2013. Available:
