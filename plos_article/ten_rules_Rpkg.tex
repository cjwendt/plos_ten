...
worst, a CRAN package might have a solid framework with help files for
...
files, vignettes, \texttt{README} files, \texttt{pkgdown} documentation,
and tutorials. Broader help resources can include webpages or online
books whose content is hosted outside the package source, online
tutorials, mailing lists, and large and vocal communities of users.

At the most granular level, each R package should come with a help file
...
function in the package, you can access its help file from the console
by typing \texttt{?} followed by the function's name (e.g., to get the
help file for the \texttt{mean} function, type \texttt{?mean}). Function
help files include information about how to use the function, including
...
static HTML documentation {[}41{]}. This tool allows developers to
...
and GitHub {[}46{]}. RDocumentation may include: an overview,
...
downloadable online book {[}47{]}. The \texttt{bookdown} package itself
has an \href{https://bookdown.org/yihui/bookdown/}{online book} that
details usage of the package {[}48{]}. \texttt{Rccp} is another package
...
package from the Tutorial pane in the IDE {[}49{]}. Finally, keep in
...
problem-solving as hallmarks of its online presence {[}50{]}. The modern
...
(R-packages) {[}51{]}. Certain packages have independent listservs;
...
metrics {[}6,52{]}. When you encounter a problem, it is good practice to
...
posting a reproducible example {[}53{]}. Overall, avoid using a package
...
following and widespread usage {[}54{]}. Likewise, the number of Google
...
skew the calculation {[}55{]}. You can research stats on corresponding
...
A Package for Helping You Choose Which Package to Use} {[}56{]}. Fun
fact: the \texttt{packagemetrics} project was born at an Unconference
{[}57{]}. You can install \texttt{packagemetrics} via
...
archive so that code can be cited in academic literature {[}58{]}. If a
...
establish trust in certain tools more quickly than others {[}54{]}.
...
create {[}59{]}. There are concrete ways to measure a tool's robustness
...
an automated process called unit testing {[}24,60{]}. Although
...
{[}61{]}. Developers are also interested in quantifying the amount of
...
function, script, and package levels {[}62{]}. Relatedly, developers who
...
{[}63{]}. You may see, for example, license, dependency, or style
...
package development and computational literacy more broadly {[}24,64{]}.
...
about lab procedures are to experimental science'' {[}{[}64{]}; p6{]}.
...
{[}65{]}. GitHub works in conjunction with Git to provide a powerful
...
{[}1,66{]}. As you may expect, Git coupled with GitHub is the version
...
installation {[}59{]}. Vignettes include many common data science
...
a ``pipeline'', expects data frame objects {[}67{]}. Thus, when you are
...
\texttt{tidyverse} workflow {[}68,69{]}. Furthermore, the \texttt{caret}
...
{[}71,72{]}. Functions are necessary for efficiency and warranted when
you repetitiously copy and paste your code while making slight
modifications after each iteration {[}53{]}. The concept of personal R
...
documentation with reproducibility and collaboration in mind {[}73{]}.
...
of code, data, documentation, versions, and tests {[}59{]}. Similarly,
...
\texttt{roxygen2}, \texttt{rlang}, \texttt{drat}) {[}32,38,74--77{]}. In
...
41. Wickham H, Hesselberth J. Pkgdown {[}Internet{]}. RStudio; 2018.
...
43. Tierney N, Cook D, McBain M, Fay C. Naniar: Data structures,
...
44. Riemondy KA, Sheridan RM, Gillen A, Yu Y, Bennett CG, Hesselberth
...
45. Didelot, Xavier, Fraser, Christophe, Gardy, Jennifer, et al. Genomic
...
46. RDocumentation {[}Internet{]}. DataCamp Inc. 2020. Available:
\url{https://www.rdocumentation.org/}

\leavevmode\hypertarget{ref-bookdown}{}%
47. Xie Y. Bookdown: Authoring books and technical documents with r
markdown {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=bookdown}

\leavevmode\hypertarget{ref-xie2016}{}%
48. Xie Y. Bookdown: Authoring books and technical documents with r
markdown. Chapman; Hall/CRC; 2016.

\leavevmode\hypertarget{ref-ushey2020}{}%
49. Ushey K. RStudio 1.3 preview: Integrated tutorials {[}Internet{]}.
...
50. Chase W. Dataviz and the 20th anniversary of r, an interview with
...
52. Muenchen RA. The popularity of data analysis software. URL
http://r4statscom/popularity. 2012;

\leavevmode\hypertarget{ref-wickham2014}{}%
53. Wickham H. Advanced r. CRC press; 2014.

\leavevmode\hypertarget{ref-leek2015}{}%
54. Leek J. How i decide when to trust an r package {[}Internet{]}.
2015. Available:
...
55. Vannoorenberghe L. RDocumentation: Scoring and ranking
...
56. Firke S, Krouse B, Grand E, Shepherd L, Ampeh W, Frick H.
...
57. Becca Krouse HF Erin Grand. Packagemetrics - helping you choose a
...
61. Wickham H. Testthat: Get started with testing. The R Journal.
2011;3: 5--10. Available:
\url{https://journal.r-project.org/archive/2011-1/RJournal_2011-1_Wickham.pdf}

\leavevmode\hypertarget{ref-covr}{}%
62. Hester J. Covr: Test coverage for packages {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=covr}

\leavevmode\hypertarget{ref-barts2018}{}%
63. Barts C. How to use github badges to stop feeling like a noob
...
64. Wilson GV. Where's the real bottleneck in scientific computing?
American Scientist. 2006;94: 5.

\leavevmode\hypertarget{ref-bryan2018}{}%
65. Bryan J. Excuse me, do you have a moment to talk about version
control? The American Statistician. Taylor \& Francis; 2018;72: 20--27.

\leavevmode\hypertarget{ref-perkel2016}{}%
66. Perkel J. Democratic databases: Science on github. Nature News.
2016;538: 127.

\leavevmode\hypertarget{ref-tidyverse}{}%
67. Wickham H, Averick M, Bryan J, Chang W, McGowan LD, François R, et
al. Welcome to the tidyverse. Journal of Open Source Software. 2019;4:
1686.
doi:\href{https://doi.org/10.21105/joss.01686}{10.21105/joss.01686}

\leavevmode\hypertarget{ref-broom}{}%
68. Robinson D, Hayes A. Broom: Convert statistical analysis objects
into tidy tibbles {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=broom}

\leavevmode\hypertarget{ref-biobroom}{}%
69. Andrew J. Bass SL David G. Robinson. Biobroom: Turn bioconductor
