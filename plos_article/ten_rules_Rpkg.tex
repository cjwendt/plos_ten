...
updated (e.g., bug fixes, general improvements, functional additions)
{[}30{]}. You can explore the version history of a package to see if it
is up-to-date. As a user, there are two additional development protocols
that you can further investigate to assess the underlying stability and
utility of a package: unit tests and version control.
...
them as previous versions to be revisited. In other words, ``version
control is as fundamental to programming as accurate notes about lab
procedures are to experimental science'' {[}35{]}. Git is a
...
uses {[}38,39{]}. Functions are necessary for efficiency and warranted
...
documentation with reproducibility and collaboration in mind {[}40{]}.
...
{[}17,41{]}{[}42{]}{[}43{]}{[}44{]}{[}18{]}. In the case of
...
implement transparent systems {[}46,47{]}. It follows that former
...
irresponsible {[}48{]}. The open source R language has become the
...
across subsets of the scientific community {[}48{]}. R is increasingly
...
reproducibility {[}12,49{]}. More broadly, as the R ecosystem---in which
...
theoretical statistics {[}48{]}. Packages greatly enhance the user
...
38. Harrell Jr FE, Charles Dupont, others. Hmisc: Harrell miscellaneous
{[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=Hmisc}

\leavevmode\hypertarget{ref-broman}{}%
39. Broman KW. Broman: Karl broman's r code {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=broman}

\leavevmode\hypertarget{ref-parker2013}{}%
40. Parker H. Personal r packages {[}Internet{]}. 2013. Available:
\url{https://hilaryparker.com/2013/04/03/personal-r-packages/}

\leavevmode\hypertarget{ref-usethis}{}%
41. Wickham H, Bryan J. Usethis: Automate package and project setup
...
48. Donoho D. 50 years of data science. Journal of Computational and
Graphical Statistics. Taylor \& Francis; 2017;26: 745--766.

\leavevmode\hypertarget{ref-holmes2018}{}%
49. Holmes S, Huber W. Modern statistics for modern biology
