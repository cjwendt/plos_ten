...
a vector of packages of interest, by name {[}40,74{]}. Then, you can use
...
widely used (\textbf{Figure of table output}) {[}74,76{]}.
...
repository {[}26,33{]}. Just as you're happy to know that a manufacturer
...
workflow {[}76,91,92{]}. Similarly, the \texttt{caret} package
