...
may find it difficult to navigate the available packages, choosing one
that is robust, well-tested and well-documented, and suited to their
task. In this article, we present 10 simple rules to help researchers
new to R as they navigate this vast ecosystem of available R packages.
...
specific functionality (see \textbf{Fig 1}). Alternatively, you can
...
provide tools for analyzing biological data (see \textbf{Fig 2}). Your
...
activity, association, and review (see \textbf{Fig 3}).
