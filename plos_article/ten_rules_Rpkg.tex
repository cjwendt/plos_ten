...
\item
  Find and collect options
\item
  Check how it's shared
\item
  Explore the availability and quality of help
\item
  Quantify how established it is
\item
  Seek evidence of peer acceptance and review
\item
  Find out who developed it
\item
...
packages are published on CRAN or Bioconductor {[}41{]}, GitHub is still
...
widely used (\textbf{Figure of table output}) {[}75,77{]}.
