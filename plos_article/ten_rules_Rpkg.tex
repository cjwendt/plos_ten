...
Implicitly, if an author has taken the time to provide copious and
useful help documentation---within package code, outside of it, or
...
Certain packages have independent listservs; \texttt{statnet} is an
...
following and widespread usage {[}56{]}. Likewise, the number of Google
...
skew the calculation {[}57{]}. You can research stats on corresponding
...
archive so that code can be cited in academic literature {[}60{]}. If a
