...
implement transparent systems {[}2,3{]}. It follows that former
...
deemed irresponsible {[}4{]}.

The open source R language has become a dominant quantitative
programming environment in academic statistics, enabling researchers to
share workflows and re-execute scripts within and across subsets of the
scientific community {[}4{]}. R is increasingly used by researchers in
computational biology and bioinformatics, one of many disciplines that
is generating extensive heterogenous and complex data that demand
standard tools and rigorous methods to support reproducibility
{[}5,6{]}. More broadly, as the R ecosystem---in which the life of
...
languages, particularly in academia, healthcare, and government {[}7{]}.

R was developed by statisticians and is collaboratively maintained by an
international core group of contributors {[}8{]}. Unlike several popular
...
\texttt{tidyr} {[}9,10{]} (see Table 1). Nevertheless, there are indeed
...
objects---which impose restrictions when creating graphics {[}12{]}. The
...
aspect of a software's success {[}13{]}. A defining feature of R is the
...
releases of new packages {[}14{]}. Beyond social media, featured pages
...
for use by anyone) {[}15{]}. If your task is specific to a line of
...
{[}17{]}. Some repositories impose vetting mechanisms that tame unwieldy
...
designated package library {[}18{]}. When you want to use a particular
...
statistical computing knowledge in the world'' {[}15{]}. Evidently, much
...
{[}19{]}. As such, CRAN only considers packages that make a substantial
...
reproducibility in research on biological processes {[}5{]}. The R
...
experience with R (see Rule 4) {[}5{]}. Similar to CRAN, Bioconductor
...
{[}20{]}. Bioconductor packages facilitate the analysis and
...
GitHub {[}15,21,22{]}. While there are practical downsides to their
...
package on GitHub {[}15,21{]}. GitHub is a popular online user interface
...
such packages are often published on CRAN or Bioconductor {[}23{]}.
...
installs corresponding dependencies {[}24{]}. For developers, GitHub
...
GitHub {[}25,26{]}. Both R users and package developers benefit from
...
community {[}27{]}. The repository only includes packages that have
...
for statistical software {[}17{]}. No such resources have been
...
downloadable online book {[}30{]}. The \texttt{bookdown} package itself
has an \href{https://bookdown.org/yihui/bookdown/}{online book} that
details usage of the package {[}31{]}. \texttt{Rccp} is another package
...
package from the Tutorial pane in the IDE {[}32{]}. Finally, keep in
...
problem-solving as hallmarks of its online presence {[}33{]}. The modern
...
(R-packages) {[}34{]}. Certain packages have independent listservs;
...
metrics {[}7,35{]}. When you encounter a problem, it is good practice to
...
posting a reproducible example {[}36{]}. Overall, avoid using a package
if the quality and quantity of related resources is lacking.

\hypertarget{rule-5-find-out-who-developed-it}{%
\section{Rule 5: Find out who developed
it}\label{rule-5-find-out-who-developed-it}}
...
\hypertarget{rule-6-see-how-its-developed}{%
\section{Rule 6: See how it's
developed}\label{rule-6-see-how-its-developed}}
...
create {[}38{]}. There are concrete ways to measure a tool's robustness
...
general improvements, new functionality) {[}1,18{]}. You can explore the
...
an automated process called unit testing {[}18,39{]}. Although
...
code that is not sensitive to major changes in the future {[}18{]}. To
...
{[}40{]}. Developers are also interested in quantifying the amount of
...
function, script, and package levels {[}41{]}. Relatedly, developers who
...
{[}42{]}. You may see, for example, license, dependency, or style
...
package development and computational literacy more broadly {[}18,43{]}.
...
about lab procedures are to experimental science'' {[}{[}43{]}; p6{]}.
...
{[}44{]}. GitHub works in conjunction with Git to provide a powerful
...
{[}1,45{]}. As you may expect, Git coupled with GitHub is the version
control duo of choice among serious R package developers {[}18{]}. Thus,
...
\hypertarget{rule-7-seek-evidence-of-peer-acceptance-and-review}{%
\section{Rule 7: Seek evidence of peer acceptance and
review}\label{rule-7-seek-evidence-of-peer-acceptance-and-review}}
...
archive so that code can be cited in academic literature {[}46{]}. If a
...
source tools with peer reviewed R packages (see Rule 3) {[}27{]}.

\hypertarget{rule-8-quantify-how-established-it-is}{%
\section{Rule 8: Quantify how established it
is}\label{rule-8-quantify-how-established-it-is}}
...
following and widespread usage {[}37{]}. Likewise, the number of Google
...
skew the calculation {[}47{]}. You can research stats on corresponding
...
installation {[}38{]}. Vignettes include many common data science
...
represent data {[}5{]}. On the other hand, the \texttt{tidyverse}, a
unified suite of packages with an grammatical structure employed within
a ``pipeline'', expects data frame objects {[}48{]}. Thus, when you are
...
\texttt{tidyverse} workflow {[}49,50{]}. Furthermore, the \texttt{caret}
...
can create them---more easily than you may think {[}18{]}. The reasons
...
{[}52,53{]}. Functions are necessary for efficiency and warranted when
you repetitiously copy and paste your code while making slight
modifications after each iteration {[}36{]}. The concept of personal R
...
documentation with reproducibility and collaboration in mind {[}54{]}.
...
of code, data, documentation, versions, and tests {[}38{]}. Similarly,
...
\texttt{roxygen2}, \texttt{rlang}, \texttt{drat}) {[}24,25,55--58{]}. In
...
8. Team RC. The r project for statistical computing {[}Internet{]}. The
R Foundation; 2020. Available: \url{https://www.r-project.org/}

\leavevmode\hypertarget{ref-dplyr}{}%
9. Wickham H, François R, Henry L, Müller K. Dplyr: A grammar of data
manipulation {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=dplyr}

\leavevmode\hypertarget{ref-tidyr}{}%
10. Wickham H, Henry L. Tidyr: Tidy messy data {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=tidyr}

\leavevmode\hypertarget{ref-phonenumber}{}%
11. Myles S. Phonenumber: Convert letters to numbers and back as on a
...
12. Huber W, Carey VJ, Gentleman R, Anders S, Carlson M, Carvalho BS, et
...
13. Smith D. The r community is one of r's best features {[}Internet{]}.
...
16. Zeileis A. CRAN task views. R News. 2005;5: 39--40.

\leavevmode\hypertarget{ref-hornik2012}{}%
17. Hornik K. Are there too many r packages? Austrian Journal of
...
23. Decan A, Mens T, Claes M, Grosjean P. On the development and
...
24. Wickham H, Hester J, Chang W. Devtools: Tools to make developing r
packages easier {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=devtools}

\leavevmode\hypertarget{ref-drat}{}%
25. Carl Boettiger DE with contributions by, Fultz N, Gibb S, Gillespie
...
26. Anderson GB, Eddelbuettel D. Hosting data packages via drat: A case
study with hurricane exposure data. R Journal. 2017;9.

\leavevmode\hypertarget{ref-ropensci2020}{}%
27. Transforming science through open data and software {[}Internet{]}.
rOpenSci; 2020. Available: \url{https://ropensci.org/}

\leavevmode\hypertarget{ref-theussl2009}{}%
28. Theußl S, Zeileis A. Collaborative software development using
...
29. Lang DT. The omegahat environment: New possibilities for statistical
...
30. Xie Y. Bookdown: Authoring books and technical documents with r
...
32. Ushey K. RStudio 1.3 preview: Integrated tutorials {[}Internet{]}.
...
33. Chase W. Dataviz and the 20th anniversary of r, an interview with
...
40. Wickham H. Testthat: Get started with testing. The R Journal.
2011;3: 5--10. Available:
\url{https://journal.r-project.org/archive/2011-1/RJournal_2011-1_Wickham.pdf}

\leavevmode\hypertarget{ref-covr}{}%
41. Hester J. Covr: Test coverage for packages {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=covr}

\leavevmode\hypertarget{ref-barts2018}{}%
42. Barts C. How to use github badges to stop feeling like a noob
...
51. Kuhn M. Caret: Classification and regression training
{[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=caret}

\leavevmode\hypertarget{ref-Hmisc}{}%
52. Harrell Jr FE, Charles Dupont, others. Hmisc: Harrell miscellaneous
{[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=Hmisc}

\leavevmode\hypertarget{ref-broman}{}%
53. Broman KW. Broman: Karl broman's r code {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=broman}

\leavevmode\hypertarget{ref-parker2013}{}%
54. Parker H. Personal r packages {[}Internet{]}. 2013. Available:
\url{https://hilaryparker.com/2013/04/03/personal-r-packages/}

\leavevmode\hypertarget{ref-usethis}{}%
55. Wickham H, Bryan J. Usethis: Automate package and project setup
