...
uses {[}40,41{]}. Functions are necessary for efficiency and warranted
...
documentation with reproducibility and collaboration in mind {[}42{]}.
...
{[}17,43{]}{[}44{]}{[}45{]}{[}46{]}{[}18{]}. In the case of
...
implement transparent systems {[}48,49{]}. It follows that former
...
irresponsible {[}50{]}. The open source R language has become the
...
across subsets of the scientific community {[}50{]}. R is increasingly
...
reproducibility {[}12,51{]}. More broadly, as the R ecosystem---in which
...
theoretical statistics {[}50{]}. Packages greatly enhance the user
...
50. Donoho D. 50 years of data science. Journal of Computational and
Graphical Statistics. Taylor \& Francis; 2017;26: 745--766.

\leavevmode\hypertarget{ref-holmes2018}{}%
51. Holmes S, Huber W. Modern statistics for modern biology
