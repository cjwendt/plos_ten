...
Many traditional methods also tend to be at odds with productivity and
collaboration; some variability in scientific outcomes can be attributed
to differences in workflow. Today, the scientific community deems the
absence of automation to be irresponsible {[}4{]}. While standards for
...
knowledge {[}5{]}. Such researchers must therefore rely on accessible
and robust tools to ensure that their computations are reproducible.

The open source R language has become a dominant quantitative
programming environment in academic data analysis, enabling researchers
to share workflows and re-execute scripts within and across subsets of
the scientific community {[}4{]}. R is increasingly popular in
computational biology and bioinformatics, two of many disciplines
generating extensive, heterogenous, and complex data wanting for
heavy-duty data analysis tools that (ideally) support reproducibility
{[}6,7{]}. More broadly, as the R ecosystem---in which the life of
modern data analysis thrives---rapidly evolves alongside the burgeoning
R community, R is exhibiting sustained growth when compared to similar
languages, particularly in academia, healthcare, and government {[}8{]}.

R was developed by statisticians and is collaboratively maintained by an
international core group of contributors {[}9{]}. Unlike several popular
...
as packages. Contributed packages comprise the bulk of enhancements made
to the R environment {[}10{]}. In fact, much of what we know about
statistical methods and algorithms is wrapped up in R packages---written
and documented in various ways by R users. There are plenty of analogies
in computing that draw comparisons between programming and culinary
...
R functions in a certain structure. Thus, the few tools that come with
your kitchen (e.g., \texttt{stats}) are indeed R packages, while ``R
extension'' describes the tools you add to your kitchen. It is important
...
package to use for a task, consider whether you need one. Consider your
purpose by first identifying your goal and defining the scope and tasks
to achieve it. For some tasks, coding your own recipe with existing
tools is practical, while other tasks benefit from new tools.
...
while base R is relatively stable and slow to change, many R packages
are rapidly evolving, and changes in packages you depend on can
``break'' parts of your code when they change.
...
accomplish the goal with less code and fewer bugs. The more reasonable
...
favor over coding from scratch. For example, there is a package for
converting English letters to numbers as on a telephone keypad {[}13{]}.

If you do decide you need a package, next ask yourself: Which
functionalities in base R are restrictive in the context of your task?
Which new functionalities would expand what you can do? If you identify
limitations of your current toolbox before searching for new tools, you
be primed to recognize what you do and do not need. List domain-specific
keywords on what you are trying to do and how you could do it, so you
can narrow your search. Identify the type of inputs you have and
...
packages in analyses and have outputs you want to visualize; you must
consider that the inputs may be of a certain class---namely, S4
objects---which impose restrictions when creating graphics {[}14{]}.
When you pick a package to visualize the data, you want to pick one that
addresses such restrictions.
...
due to the sheer quantity of available packages {[}15{]}.
...
aspect of a software's success {[}16{]}. A defining feature of R is the
...
releases of new packages {[}17{]}. R-related blogs serve as another
...
available for use by anyone) {[}18{]}. If your task is specific to a
...
the world'' {[}18{]}. A key advantage of picking a package from CRAN is
...
{[}19{]}. When you want to use a particular package, you load it to your
...
Policy before obtaining publication privileges {[}20{]}. As such, CRAN
...
processes {[}6{]}. Bioconductor packages facilitate the analysis and
...
and comply with additional package guidelines {[}21{]}.
...
{[}22{]}. The repository only includes packages that have passed their
...
Omegahat, which are beyond the scope of this paper {[}23,24{]}.
...
GitHub {[}18,25,26{]}. While there are practical downsides to their
...
package on GitHub {[}18,25{]}. GitHub is a popular online user interface
...
such packages are often published on CRAN or Bioconductor {[}27{]}.
...
installs corresponding dependencies {[}28{]}. For developers, GitHub
...
GitHub {[}29,30{]}. Both R users and package developers benefit from
...
downloadable online book {[}31{]}. The \texttt{bookdown} package itself
has an \href{https://bookdown.org/yihui/bookdown/}{online book} that
details usage of the package {[}32{]}. \texttt{Rccp} is another package
...
package from the Tutorial pane in the IDE {[}33{]}. Finally, keep in
...
problem-solving as hallmarks of its online presence {[}34{]}. The modern
...
(R-packages) {[}35{]}. Certain packages have independent listservs;
...
metrics {[}8,36{]}. When you encounter a problem, it is good practice to
...
posting a reproducible example {[}37{]}. Overall, avoid using a package
...
following and widespread usage {[}38{]}. Likewise, the number of Google
...
source tools with peer reviewed R packages (see Rule 3) {[}22{]}.
...
establish trust in certain tools more quickly than others {[}38{]}.
...
create {[}41{]}. There are concrete ways to measure a tool's robustness
...
general improvements, new functionality) {[}1,19{]}. You can explore the
...
an automated process called unit testing {[}19,42{]}. Although
...
code that is not sensitive to major changes in the future {[}19{]}. To
...
{[}43{]}. Developers are also interested in quantifying the amount of
...
function, script, and package levels {[}44{]}. Relatedly, developers who
...
{[}45{]}. You may see, for example, license, dependency, or style
...
package development and computational literacy more broadly {[}19,46{]}.
...
about lab procedures are to experimental science'' {[}{[}46{]}; p6{]}.
...
{[}47{]}. GitHub works in conjunction with Git to provide a powerful
...
{[}1,48{]}. As you may expect, Git coupled with GitHub is the version
control duo of choice among serious R package developers {[}19{]}. Thus,
...
installation {[}41{]}. Vignettes include many common data science
...
represent data {[}6{]}. On the other hand, the \texttt{tidyverse}, a
unified suite of packages with an grammatical structure employed within
a ``pipeline'', expects data frame objects {[}49{]}. Thus, when you are
...
\texttt{tidyverse} workflow {[}50,51{]}. Furthermore, the \texttt{caret}
...
can create them---more easily than you may think {[}19{]}. The reasons
...
{[}53,54{]}. Functions are necessary for efficiency and warranted when
you repetitiously copy and paste your code while making slight
modifications after each iteration {[}37{]}. The concept of personal R
...
documentation with reproducibility and collaboration in mind {[}55{]}.
...
of code, data, documentation, versions, and tests {[}41{]}. Similarly,
...
\texttt{roxygen2}, \texttt{rlang}, \texttt{drat}) {[}28,29,56--59{]}. In
...
6. Gentleman RC, Carey VJ, Bates DM, Bolstad B, Dettling M, Dudoit S, et
...
7. Holmes S, Huber W. Modern statistics for modern biology
...
8. Robinson D. The impressive growth of r {[}Internet{]}. Stack
...
13. Myles S. Phonenumber: Convert letters to numbers and back as on a
...
14. Huber W, Carey VJ, Gentleman R, Anders S, Carlson M, Carvalho BS, et
...
16. Smith D. The r community is one of r's best features {[}Internet{]}.
...
19. Wickham H. R packages: Organize, test, document, and share your
code. "O'Reilly Media, Inc."; 2015.

\leavevmode\hypertarget{ref-cranpolicy2020}{}%
20. CRAN repository policy {[}Internet{]}. The R Foundation; 2020.
Available:
...
22. Transforming science through open data and software {[}Internet{]}.
rOpenSci; 2020. Available: \url{https://ropensci.org/}

\leavevmode\hypertarget{ref-theussl2009}{}%
23. Theußl S, Zeileis A. Collaborative software development using
...
24. Lang DT. The omegahat environment: New possibilities for statistical
...
25. McElreath R. Statistical rethinking: A bayesian course with examples
in r and stan. CRC press; 2020.

\leavevmode\hypertarget{ref-decan2016}{}%
26. Decan A, Mens T, Claes M, Grosjean P. When github meets cran: An
...
27. Decan A, Mens T, Claes M, Grosjean P. On the development and
...
28. Wickham H, Hester J, Chang W. Devtools: Tools to make developing r
packages easier {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=devtools}

\leavevmode\hypertarget{ref-drat}{}%
29. Carl Boettiger DE with contributions by, Fultz N, Gibb S, Gillespie
...
30. Anderson GB, Eddelbuettel D. Hosting data packages via drat: A case
study with hurricane exposure data. R Journal. 2017;9.

\leavevmode\hypertarget{ref-bookdown}{}%
31. Xie Y. Bookdown: Authoring books and technical documents with r
markdown {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=bookdown}

\leavevmode\hypertarget{ref-xie2016}{}%
32. Xie Y. Bookdown: Authoring books and technical documents with r
markdown. Chapman; Hall/CRC; 2016.

\leavevmode\hypertarget{ref-ushey2020}{}%
33. Ushey K. RStudio 1.3 preview: Integrated tutorials {[}Internet{]}.
...
34. Chase W. Dataviz and the 20th anniversary of r, an interview with
...
35. Team RC. Mailing lists {[}Internet{]}. The R Foundation; 2020.
Available: \url{https://www.r-project.org/mail.html}

\leavevmode\hypertarget{ref-muenchen2012}{}%
36. Muenchen RA. The popularity of data analysis software. URL
...
38. Leek J. How i decide when to trust an r package {[}Internet{]}.
2015. Available:
...
41. Taschuk M, Wilson G. Ten simple rules for making research software
more robust. PLoS computational biology. Public Library of Science;
2017;13.

\leavevmode\hypertarget{ref-hester2020}{}%
42. Hester J. How does covr work anyway? {[}Internet{]}. The R
...
43. Wickham H. Testthat: Get started with testing. The R Journal.
2011;3: 5--10. Available:
\url{https://journal.r-project.org/archive/2011-1/RJournal_2011-1_Wickham.pdf}

\leavevmode\hypertarget{ref-covr}{}%
44. Hester J. Covr: Test coverage for packages {[}Internet{]}. 2020.
Available: \url{https://CRAN.R-project.org/package=covr}

\leavevmode\hypertarget{ref-barts2018}{}%
45. Barts C. How to use github badges to stop feeling like a noob
...
46. Wilson GV. Where's the real bottleneck in scientific computing?
American Scientist. 2006;94: 5.

\leavevmode\hypertarget{ref-bryan2018}{}%
47. Bryan J. Excuse me, do you have a moment to talk about version
control? The American Statistician. Taylor \& Francis; 2018;72: 20--27.

\leavevmode\hypertarget{ref-perkel2016}{}%
48. Perkel J. Democratic databases: Science on github. Nature News.
2016;538: 127.

\leavevmode\hypertarget{ref-tidyverse}{}%
49. Wickham H, Averick M, Bryan J, Chang W, McGowan LD, François R, et
al. Welcome to the tidyverse. Journal of Open Source Software. 2019;4:
1686.
doi:\href{https://doi.org/10.21105/joss.01686}{10.21105/joss.01686}

\leavevmode\hypertarget{ref-broom}{}%
50. Robinson D, Hayes A. Broom: Convert statistical analysis objects
into tidy tibbles {[}Internet{]}. 2020. Available:
\url{https://CRAN.R-project.org/package=broom}

\leavevmode\hypertarget{ref-biobroom}{}%
51. Andrew J. Bass SL David G. Robinson. Biobroom: Turn bioconductor
