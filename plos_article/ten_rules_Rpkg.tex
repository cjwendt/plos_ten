...
The R package, \texttt{packagemetrics}, is a convenient tool for directly comparing currently available packages in an area of interest, using metrics related to package development, documentation, and compatibility with other packages.}
\label{fig7}
\end{figure}
