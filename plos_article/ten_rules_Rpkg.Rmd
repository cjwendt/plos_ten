...
All the help documentation mentioned so far is incorporated in the source code of the package, and so you can investigate it by looking through the package's code. However, there are also easier avenues for investigating this help documentation that is encoded in the package. RDocumentation, for example, is a searchable [website](https://www.rdocumentation.org/), package (`install.packages("RDocumentation")`), and [JSON API]( https://www.rdocumentation.org/docs/
